...
void peak__peak_number_() {
  ...
  lineardoublegaus->SetParameter(2,_peak_number_);
  lineardoublegaus->SetParameter(3, 2.1);
  lineardoublegaus->FixParameter(4, _amplitude_ratio_);
  lineardoublegaus->FixParameter(5, _mean_ratio_);
  lineardoublegaus->SetParameter(6, 1);
  Energy_peak_number_->Fit("linear+doublegaus");
  Double_t offset__peak_number_ = lineardoublegaus->GetParameter(0);
  Double_t linear__peak_number_ = lineardoublegaus->GetParameter(7);
  Double_t amplitude1__peak_number_ = lineardoublegaus->GetParameter(1);
  Double_t mean1__peak_number_ = lineardoublegaus->GetParameter(2);
  Double_t sigma1__peak_number_ = lineardoublegaus->GetParameter(3);
  Double_t amplitude2__peak_number_ = lineardoublegaus->GetParameter(1) * lineardoublegaus->GetParameter(4);
  Double_t mean2__peak_number_ = lineardoublegaus->GetParameter(5) * lineardoublegaus->GetParameter(2);
  Double_t sigma2__peak_number_ = lineardoublegaus->GetParameter(6);
  ...
  mean.setRange(mean1__peak_number_-1, mean1__peak_number_+1);
  mean.setVal(mean1__peak_number_);
  mean2.setRange(mean2__peak_number_ - 1, mean2__peak_number_ + 1);
  mean2.setVal(mean2__peak_number_);
  a0.setVal(offset__peak_number_);
  a1.setVal(linear__peak_number_);
  
  doublegausslin.fitTo(data_peak_number_);
  doublegausslin.plotOn(frame_peak_number_);
  doublegausslin.plotOn(frame_peak_number_, Components(p2), LineStyle(kDashed));
  ...
  Double_t efficiency__peak_number = doublegausfrac.getVal();
